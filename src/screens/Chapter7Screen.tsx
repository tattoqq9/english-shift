...
export function Chapter7Screen() {
  ...
  const day = selectedDay ? chapter7Days.find((item) => item.day === selectedDay) : undefined
  const activity = day ? chapter7ActivityById(day.activityIds[activityIndex]) : undefined
